...
namespace K2Field.SmartObjects.Services.MicrosoftGraphExample
{
    public class ServiceBroker : ServiceAssemblyBase
    {
        ...
        {
            base.Service.Name = "MicrosoftGraphCustomBrokerExample";
            base.Service.MetaData.DisplayName = "Microsoft Graph Custom Broker Example";
            base.Service.MetaData.Description = "Microsoft Graph Custom Broker Example";
